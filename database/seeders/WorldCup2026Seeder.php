...
class WorldCup2026Seeder extends Seeder
{
        ...
        foreach ($teams as $team) {
            DB::table('teams')->updateOrInsert(
                ...
                [
                    ...
                    'flag_url' => "https://flagcdn.com/w80/{$team['flag']}.png",
                    'created_at' => now(),
                    'updated_at' => now(),
                ]
            );
    ...
    private function seedFaqs(): void
    {
        $faqs = [
            [
                'question' => 'مسابقه پیش‌بینی جام جهانی رشت‌گلد چیست؟',
                'answer' => 'یک رویداد هیجان‌انگیز که با پیش‌بینی نتایج بازی‌های جام جهانی، امکان برنده شدن جایزه طلا را فراهم می‌کند.',
            ],
            [
                'question' => 'آیا می‌توانم پیش‌بینی خود را ویرایش کنم؟',
                'answer' => 'بله، تا قبل از شروع بازی می‌توانید پیش‌بینی خود را ویرایش کنید. بعد از شروع بازی، پیش‌بینی قفل می‌شود.',
            ],
            [
                'question' => 'امتیازها چطور محاسبه می‌شوند؟',
                'answer' => 'امتیازها براساس دقت پیش‌بینی نتیجه، برنده و تفاضل گل محاسبه می‌شوند.',
            ],
        ];
    ...
    {
        /*
         * Times below are based on Eastern Time and converted to UTC for DB storage.
         * status:
         * scheduled = آینده
         * finished  = تمام‌شده
         */
        ...
        $matches = [
            // Round of 32
            ['external_id' => 'wc2026-r32-01', 'stage_id' => 2, 'home' => 2, 'away' => 5, 'date' => '2026-06-28 15:00:00', 'home_score' => 0, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-02', 'stage_id' => 2, 'home' => 9, 'away' => 22, 'date' => '2026-06-29 13:00:00', 'home_score' => 2, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-03', 'stage_id' => 2, 'home' => 17, 'away' => 14, 'date' => '2026-06-29 16:30:00', 'home_score' => 1, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-04', 'stage_id' => 2, 'home' => 21, 'away' => 10, 'date' => '2026-06-29 21:00:00', 'home_score' => 1, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-05', 'stage_id' => 2, 'home' => 19, 'away' => 36, 'date' => '2026-06-30 13:00:00', 'home_score' => 1, 'away_score' => 2, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-06', 'stage_id' => 2, 'home' => 33, 'away' => 23, 'date' => '2026-06-30 17:00:00', 'home_score' => 3, 'away_score' => 0, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-07', 'stage_id' => 2, 'home' => 1, 'away' => 20, 'date' => '2026-06-30 22:00:00', 'home_score' => 2, 'away_score' => 0, 'status' => 'finished'],

            ['external_id' => 'wc2026-r32-08', 'stage_id' => 2, 'home' => 45, 'away' => 42, 'date' => '2026-07-01 12:00:00', 'home_score' => 2, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-09', 'stage_id' => 2, 'home' => 25, 'away' => 34, 'date' => '2026-07-01 16:00:00', 'home_score' => 3, 'away_score' => 2, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-10', 'stage_id' => 2, 'home' => 13, 'away' => 6, 'date' => '2026-07-01 20:00:00', 'home_score' => 2, 'away_score' => 0, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-11', 'stage_id' => 2, 'home' => 29, 'away' => 39, 'date' => '2026-07-02 15:00:00', 'home_score' => 3, 'away_score' => 0, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-12', 'stage_id' => 2, 'home' => 41, 'away' => 46, 'date' => '2026-07-02 19:00:00', 'home_score' => 2, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-13', 'stage_id' => 2, 'home' => 8, 'away' => 38, 'date' => '2026-07-02 23:00:00', 'home_score' => 2, 'away_score' => 0, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-14', 'stage_id' => 2, 'home' => 15, 'away' => 26, 'date' => '2026-07-03 14:00:00', 'home_score' => 1, 'away_score' => 1, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-15', 'stage_id' => 2, 'home' => 37, 'away' => 30, 'date' => '2026-07-03 18:00:00', 'home_score' => 3, 'away_score' => 2, 'status' => 'finished'],
            ['external_id' => 'wc2026-r32-16', 'stage_id' => 2, 'home' => 44, 'away' => 47, 'date' => '2026-07-03 21:30:00', 'home_score' => 1, 'away_score' => 0, 'status' => 'finished'],

            // Round of 16
            ['external_id' => 'wc2026-r16-01', 'stage_id' => 3, 'home' => 5, 'away' => 10, 'date' => '2026-07-04 13:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-02', 'stage_id' => 3, 'home' => 14, 'away' => 33, 'date' => '2026-07-04 17:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-03', 'stage_id' => 3, 'home' => 9, 'away' => 36, 'date' => '2026-07-05 16:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-04', 'stage_id' => 3, 'home' => 1, 'away' => 45, 'date' => '2026-07-05 20:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-05', 'stage_id' => 3, 'home' => 41, 'away' => 29, 'date' => '2026-07-06 15:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-06', 'stage_id' => 3, 'home' => 13, 'away' => 25, 'date' => '2026-07-06 20:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-07', 'stage_id' => 3, 'home' => 37, 'away' => 26, 'date' => '2026-07-07 12:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
            ['external_id' => 'wc2026-r16-08', 'stage_id' => 3, 'home' => 8, 'away' => 44, 'date' => '2026-07-07 16:00:00', 'home_score' => null, 'away_score' => null, 'status' => 'scheduled'],
        ];
